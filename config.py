...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('postgres://default:x1SfVbRac7vX@ep-solitary-dust-a1cazav3.ap-southeast-1.aws.neon.tech:5432/verceldb?sslmode=require') 
